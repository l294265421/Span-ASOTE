...
class TagReader:
    ...
    @classmethod
    def read_inst(cls, file, is_labeled, number, opinion_offset, train=False):
        insts = []
        # inputs = []
        # outputs = []
        total_p = 0
        ...
        for line in f:
            ...
            if len(new_pairs) > 0 or not train:
                ...
                if len(insts) >= number > 0:
                    break
        print('# sentence_num_with_pairs: %d', sentence_num_with_pairs)
